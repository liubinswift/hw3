...
import com.viewscenes.web.common.RunPlan;
import com.viewscenes.web.common.ProgramInfo;
...
//根据unit,headcode,ruplantype得到站点的运行图sql语句
    public static String runplanSql(String head_code,String runplan_type,String nowTime) throws ModuleException {
        if (head_code == null) {
     head_code = "";
   }
   ...
   try {
     ...
     throw new ModuleException("时间格式异常!", ex);
   }
   ...
   try {
     ...
     throw new ModuleException("时间格式异常!", ex1);
   }
