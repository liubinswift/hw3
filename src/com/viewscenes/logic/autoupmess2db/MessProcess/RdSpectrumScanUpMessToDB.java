...
public class RdSpectrumScanUpMessToDB implements IUpMsgProcessor {
...
//
//            String sql =
//                    "insert into task_tv_spectrum_data_tab (Task_id,Scan_time,Freq,Level) "
...
//            e.printStackTrace();
//
//            LogTool.warning("修改广播频谱任务数据库失败" + e.getMessage());
//
//        }
//    }
//
